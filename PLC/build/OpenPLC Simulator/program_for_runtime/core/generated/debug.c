...
char plc_program_md5[] = "692fc1a8790afb669c0517a41778d9ea";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.TEMPERATURE), INT_ENUM},
    {&(RES0__INSTANCE0.HIGH_LIMIT), INT_ENUM},
    {&(RES0__INSTANCE0.CRITICAL_LIMIT), INT_ENUM},
    {&(RES0__INSTANCE0.SENSOR_FAULT), BOOL_ENUM},
    {&(RES0__INSTANCE0.ALARM_HIGH), BOOL_ENUM},
    {&(RES0__INSTANCE0.ALARM_CRITICAL), BOOL_ENUM},
    {&(RES0__INSTANCE0.SYSTEM_OK), BOOL_ENUM},
    {&(RES0__INSTANCE0.HEATER_ON), BOOL_ENUM},
};
